...
/**
 * Server-side Supabase client, respects the caller's auth session via cookies.
...
/**
 * Service-role client — bypasses RLS. NEVER expose to the client bundle.
 * Only import this inside API route handlers / server-only code.
 */
